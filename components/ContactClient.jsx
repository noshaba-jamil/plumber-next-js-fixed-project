      ...
      <section className="section section-alt">
        <div className="container">
          ...
          <div style={{ marginBottom: 48 }}>
            ...
            <div className="content-block" style={{ marginTop: 14, maxWidth: 700 }}>
          ...
          <div className="contact-layout">
            ...
            <div>
              ...
              <h2 className="sh" style={{ marginBottom: 24 }}>Reach Us <em>Anytime</em></h2>
              ...
              <div className="emerg-cta-block">
                ...
                <a href={CONTACT_INFO.phoneHref} className="btn-gold" style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
                  <i className="ri-phone-fill" />Call {CONTACT_INFO.phone} Now
                </a>
              </div>
              ...
              <div className="services-avail-block">
                ...
                {SERVICES.map(s => (
                  <Link key={s.id} href={s.slug} className="service-avail-item">
                    ...
                    <i className="ri-arrow-right-s-line" style={{ marginLeft: 'auto', color: 'var(--text-dimmer)' }} />
                  </Link>
                ))}
              </div>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20, flexWrap: 'wrap', gap: 12 }}>
              <div>
                ...
                <h3 style={{ fontFamily: "'DM Serif Display', serif", fontWeight: 400, fontSize: 28, color: '#fff' }}>
                  Serving <span style={{ color: 'var(--gold)' }}>Springfield, Missouri</span>
                </h3>
              </div>
          ...
          {/* Schedule CTA block */}
          <div style={{ background: 'var(--card)', border: '1px solid rgba(255,255,255,0.05)', padding: 40, marginTop: 3, textAlign: 'center' }}>
            <h2 className="sh" style={{ marginBottom: 12 }}>Schedule Your Plumbing <em>Service Today</em></h2>
            <p style={{ color: 'var(--text-dim)', maxWidth: 600, margin: '0 auto 24px' }}>
