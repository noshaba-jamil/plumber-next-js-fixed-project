 ...
 * ✅ AggregateRating added (star ratings in Google)
...
export const LOCAL_BUSINESS_SCHEMA = {
  ...
  email: 'springfieldmoplumber@gmail.com',       // ✅ FIXED — professional email
  ...
  geo: {                                         // ✅ ADDED — helps Google Maps ranking
    '@type': 'GeoCoordinates',
    latitude: 37.2090,
    longitude: -93.2923,
  },
  ...
  aggregateRating: {                             // ✅ ADDED — shows stars in Google results
  ...
  sameAs: [                                      // ✅ ADDED — link your social/directory profiles
