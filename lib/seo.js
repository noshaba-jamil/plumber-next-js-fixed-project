 ...
 *
 * ── FIX (business-entity consistency pass) ──────────────────────
 * BASE_METADATA.openGraph.siteName previously said 'Springfield
 * Emergency Plumbing' — a third instance of the name mismatch found
 * during the blog-schema cleanup (blog pages used the same wrong
 * name; already fixed there). Every other siteName reference on the
 * site — buildOpenGraph() below, LOCAL_BUSINESS_SCHEMA, WEBSITE_SCHEMA
 * — uses 'Springfield MO Plumber'. Synced this one to match.
 */
...
export const LOCAL_BUSINESS_SCHEMA = {
  ...
  areaServed: [
    ...
    { '@type': 'City', name: 'Spokane' },
    {
      '@type': 'City',
      name: 'Neosho',
      sameAs: 'https://en.wikipedia.org/wiki/Neosho,_Missouri',
    },
  ],
  priceRange: '$$',
