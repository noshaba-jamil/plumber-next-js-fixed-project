 ...
 *
 * ── CANNIBALIZATION FIX (P1 cluster) ──────────────────────────
 * home, contact, faq, areas titles/H1s rewritten to stop competing
 * with /emergency-plumber-springfield-mo for "emergency plumber
 * springfield mo" and variants. That page (PAGE_META.emergency)
 * keeps its exact-match title/H1 — it's the intended target.
 */
...
export const BASE_METADATA = {
 ...
 export const PAGE_META = {
  // ── UPDATED (cannibalization fix, item 1 + title-duplicate finding) ──
  // Old title was 'Emergency Plumber Springfield MO — 24/7, Near Me' —
  // nearly identical to the emergency page's title below. Old H1 was
  // 'Emergency Plumber in Springfield MO — 24/7 Fast Plumbing Repair'.
  home: {
    title: '24/7 Plumber Springfield MO | Fast, Upfront Pricing',
    ...
    canonical: `${SITE_URL}`,
    h1: '24/7 Plumber in Springfield MO — Fast, Upfront Pricing',
  },
  services: {
  ...
  about: {
    ...
    h1: 'Meet Our Springfield MO Plumbing Team',
  },
  // ── UPDATED (cannibalization fix, item 2) ──
  // Old title was 'Contact Emergency Plumber Springfield MO | 24/7'.
  // Old H1 was 'Contact Our Emergency Plumber in Springfield MO'.
  contact: {
    title: 'Contact Us | Springfield Mo Plumber',
    description: 'Contact Springfield MO trusted plumber. 24/7. Fast response. Call (417) 373-4862 or submit our quick form for immediate help.',
    canonical: `${SITE_URL}/contact`,
    h1: 'Get in Touch — Request Service',
  },
  // ── UPDATED (cannibalization fix, item 3) ──
  // Old H1 was 'Frequently Asked Questions — Emergency Plumber Springfield MO'.
  // Title was already safe (no exact-match phrase) — left unchanged.
  faq: {
  ...
  // ── UPDATED (cannibalization fix, item 4) ──
  // Title was already hub-style here in PAGE_META, but the actual
  // app/service-areas/page.jsx route file had a DIFFERENT hardcoded
  // title ('Plumber Springfield MO | Nixa, Ozark, Republic & More')
  // that bypassed this config entirely — fixed separately in that file.
  // Synced this entry's title to match for consistency.
  areas: {
  ...
  // ── TARGET PAGE — kept exact-match on purpose, this is what all the
  // other pages above are now consolidating ranking signal toward. ──
  emergency: {
    title: 'Emergency Plumber Springfield MO | 24/7, $0 Call-Out Fee',
    description: 'Burst pipe or sewer backup in Springfield MO? Real person answers 24/7. Arrive in 30-60 min. $0 call-out fee, upfront pricing. Call (417) 373-4862.',
  ...
  waterHeaterInstall: {
    title: 'Water Heater Installation & Replacement Springfield MO',
    description: 'New water heater installation & replacement in Springfield MO — tank & tankless, all brands. Old unit removal included. Call (417) 373-4862.',
    canonical: `${SITE_URL}/water-heater-installation-springfield-mo`,
    h1: 'Water Heater Installation & Replacement in Springfield, MO',
  },
  tanklessInstall: {
...
export const FAQ_SCHEMAS = {
  pipe: {
    ...
    mainEntity: [
      { '@type': 'Question', name: 'How much does pipe repair cost in Springfield, MO?', acceptedAnswer: { '@type': 'Answer', text: 'A single pipe repair typically costs $200–$600 depending on pipe type, location, and accessibility. Partial re-piping of a specific area runs $500–$2,000. We provide a full written estimate before any work begins.' } },
      { '@type': 'Question', name: 'How do I know if my Springfield home needs re-piping instead of a single repair?', acceptedAnswer: { '@type': 'Answer', text: 'If your home has galvanized steel pipes older than 40 years, brown or rust-colored water, multiple leaks in a short period, or persistent low pressure that isolated repairs haven\'t fixed, whole-home re-piping is often more cost-effective than repeated spot repairs.' } },
      { '@type': 'Question', name: 'Do you repair copper, PVC, and PEX pipes?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We work with all pipe materials used in Springfield MO homes — copper, PVC, CPVC, PEX, and older galvanized steel — and carry common fittings for each on every truck.' } },
      { '@type': 'Question', name: 'How fast can you repair a leaking or burst pipe?', acceptedAnswer: { '@type': 'Answer', text: 'Most single pipe repairs are completed same-day, often on the first visit, since our trucks carry copper, PVC, and PEX fittings for the most common repair scenarios.' } },
    ],
  },
  faq: {
    '@context': 'https://schema.org',
  ...
  emergency: {
    ...
    mainEntity: [
      ...
      },
      {
        '@type': 'Question',
        name: 'How much does an emergency plumber cost in Springfield MO?',
        acceptedAnswer: { '@type': 'Answer', text: 'Most emergency repairs range from $150–$800 depending on the issue — burst pipe repair runs $200–$600, toilet clearing $150–$300, sewer backup clearing $300–$600. We give you a full written estimate before any work begins, so you always know the price first.' },
      },
      {
        '@type': 'Question',
        name: 'Are your emergency plumbers licensed and insured in Missouri?',
        acceptedAnswer: { '@type': 'Answer', text: 'Yes. Every plumber we dispatch is licensed by the State of Missouri, fully insured, and background-checked. You can verify any plumber\'s license at pr.mo.gov before they arrive.' },
      },
      {
        '@type': 'Question',
        name: 'Do you answer the phone yourselves, or does it go to voicemail?',
        acceptedAnswer: { '@type': 'Answer', text: 'A real person answers every call — 24 hours a day, 7 days a week, including holidays. We never route emergency calls to voicemail or an answering service.' },
      },
    ],
  },
  drain: {
  ...
  heater: {
    ...
    mainEntity: [
      ...
      {
        '@type': 'Question',
        name: 'How much does water heater repair cost in Springfield MO?',
        acceptedAnswer: { '@type': 'Answer', text: 'Most water heater repairs range from $150–$400 — a simple thermostat replacement runs about $150, while more complex gas unit repairs run up to $400. Tankless repairs typically run $200–$600. We give you a full written estimate before any work begins.' },
      },
      {
        '@type': 'Question',
        name: 'How fast can you get to me for a water heater repair?',
        acceptedAnswer: { '@type': 'Answer', text: 'We dispatch immediately and most Springfield MO homes see a plumber within 60 minutes for urgent no-hot-water calls. Same-day service is available for most water heater repairs.' },
      },
      {
        '@type': 'Question',
        name: 'Are your plumbers licensed to repair water heaters in Missouri?',
        acceptedAnswer: { '@type': 'Answer', text: 'Yes. Every plumber we send is licensed by the State of Missouri, fully insured, and background-checked. You can verify any plumber\'s license at pr.mo.gov before they arrive.' },
      },
    ],
  },
  sewer: {
